...
WebUI.click(findTestObject('Object Repository/gmail/Page_Inbox (8) - automatic.test.examplegmai_98572c/div_Compose'))

WebUI.setText(findTestObject('Object Repository/gmail/Page_Inbox (8) - automatic.test.examplegmai_98572c/input_To_lz'), 
    'automatic.test.example@gmail.com')

WebUI.setText(findTestObject('Object Repository/gmail/Page_Inbox (8) - automatic.test.examplegmai_98572c/input_Recipients_subjectbox_1'), 
    'Test')

WebUI.setText(findTestObject('Object Repository/gmail/Page_Inbox (8) - automatic.test.examplegmai_98572c/div_Resume Editing_di'), 
    'This is test.')

WebUI.click(findTestObject('Object Repository/gmail/Page_Inbox (8) - automatic.test.examplegmai_98572c/div_Send'))
